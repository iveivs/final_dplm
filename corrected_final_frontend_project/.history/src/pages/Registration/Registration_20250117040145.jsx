...
export const Registration = () => {
    ...
    const addNewUserToServer = (newUser) => {
        ...
        .then((data) => {
            console.log("User registered successfully:", data);
            // Добавляем пользователя в Redux после успешной регистрации
            dispatch(addUser(data.username, '', data.email, false)); // Замените данные согласно вашему Redux-редьюсеру
